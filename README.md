...
- [Ensayos interactivos](https://pedromvillar.github.io/Fisica/) — simulaciones para construir intuición antes de leer el apunte o la hoja resumen. En construcción: hoy sólo está "Tiro parabólico".
