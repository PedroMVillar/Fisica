...
- [`preparacion/`](./preparacion) — plan de estudio, formulario y material de repaso.
  ...
  - `practica-tiro-parabolico.pdf` — **sólo consignas, sin resolución**: los enunciados de cinemática (tiro parabólico, caída libre y movimiento rectilíneo) que se tomaron en parciales y finales viejos, ordenados de más nuevo a más viejo, primero los parciales y después los finales. Ocho de parciales (2025, 2024, 2023, 2022, 2021, 2017 y dos del 2009) y tres de finales (2009 y 2008). Es el tema del Práctico 1 salvo movimiento circular, que tiene su propia hoja.
